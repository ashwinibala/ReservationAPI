class Schedule < ApplicationRecord
  validates :service_date, :timeslot_id, :purpose, :vehicle_id, presence: true

  validate :validate_date_format

#   timeslot_id will be receieved from the dropdows which populates from the timeslot table. So it will be verified with the table values later. Currently considering out of scope.
